...
part of 'message_response_schema_referenced_message.dart';
...
_$MessageResponseSchemaReferencedMessageFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'MessageResponseSchemaReferencedMessage',
  json,
  ($checkedConvert) {
    final val = MessageResponseSchemaReferencedMessage(
      ...
      type: $checkedConvert(
        'type',
        (v) => MessageResponseSchemaReferencedMessageTypeType.fromJson(
          (v as num).toInt(),
        ),
      ),
      ...
      messageReference: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : MessageResponseSchemaReferencedMessageMessageReference.fromJson(
      ...
      call: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : MessageResponseSchemaReferencedMessageCall.fromJson(
                v as Map<String, dynamic>,
              ),
      ),
...
Map<String, dynamic> _$MessageResponseSchemaReferencedMessageToJson(
  MessageResponseSchemaReferencedMessage instance,
) => <String, dynamic>{
  'id': instance.id,
