...
class MessageEmbedResponse {
  const MessageEmbedResponse({required this.type})
    : url = null,
      _urlPresent = false,
      title = null,
      _titlePresent = false,
  ...
  const MessageEmbedResponse._explicit({
    required this.type,
    Object? url = _omit,
    Object? title = _omit,
    Object? color = _omit,
    ...
    Object? children = _omit,
       ...
       children = identical(children, _omit)
           ? null
  ...
  const MessageEmbedResponse._({
    ...
    this.children,
       ...
       _nsfwPresent = false,
       _childrenPresent = false;
  factory MessageEmbedResponse.patch(Map<String, Object?> json) =>
      MessageEmbedResponse.fromJson(json);

  factory MessageEmbedResponse.fromJson(Map<String, Object?> json) {
    final value = _$MessageEmbedResponseFromJson(json);
    return MessageEmbedResponse._explicit(
      type: value.type,
      ...
      children: json.containsKey('children') ? value.children : _omit,
    );
  }
  ...
  final bool _childrenPresent;

  Map<String, Object?> toJson() {
    final json = _$MessageEmbedResponseToJson(this);
    if (_urlPresent) {
    ...
    if (_childrenPresent) {
      json.putIfAbsent('children', () => children);
    }
    return json;
  }
}
