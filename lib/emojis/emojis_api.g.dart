...
class _EmojisApi implements EmojisApi {
  _EmojisApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<GuildEmojiMetadataResponse> getEmojiMetadata({
    ...
    final _options = _setStreamType<GuildEmojiMetadataResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/emojis/${emojiId}/metadata',
